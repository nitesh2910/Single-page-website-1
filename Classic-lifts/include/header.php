...
<head>
	...
	<meta name="description" content="sopno - Factory & Industrial HTML Template" />
	<meta property="og:title" content="sopno - Factory & Industrial HTML Template" />
	<meta property="og:description" content="sopno - Factory & Industrial HTML Template" />
	<meta property="og:image" content="" />
	<meta name="format-detection" content="telephone=no">
	
	<!-- FAVICONS ICON -->
	 <link rel="icon" href="images/logo-1.jpg" type="image/x-icon" />

	<!-- <link rel="shortcut icon" type="image/x-icon" href="images/favicon.html" /> -->
	
	<!-- PAGE TITLE HERE -->
	<title>Welcome To Classic Lifts</title>
...
<div id="loading-area" class="construct-loading"></div>
    ...
    <header class="site-header mo-left construct-header header">
			...
			<div class="container">
				<div class="row d-flex justify-content-between align-items-center">
					<div class="dlab-topbar-left">
						<ul>
							<li><a href="javascript:void(0);"><i class="fa fa-envelope-o m-r5 tetx-primary"></i>classiclifts24@gmail.com</a></li>
					...
					<div class="dlab-topbar-right">
						<ul>
							...
							<li><a href="#contact">Contact-Us:-+91 74900-40474</a></li>
						</ul>					
					</div>
				</div>
			</div>
        ...
        <div class="sticky-header main-bar-wraper navbar-expand-lg ">
            <div class="main-bar clearfix onepage" style="height: 112px;">
                <div class="container clearfix" >
                    <!-- website logo -->
                    <div class="logo-header mostion">
						<a href="index.php"><img src="images/logo-1.jpg" alt style="max-width: 111px;"></a>
					</div>
                    <!-- nav toggle button -->
